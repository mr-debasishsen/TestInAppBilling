package test.in.appbilling;

import java.util.ArrayList;
import java.util.List;

import test.in.appbilling.utils.IabBroadcastReceiver;
import test.in.appbilling.utils.IabHelper;
import test.in.appbilling.utils.IabBroadcastReceiver.IabBroadcastListener;
import test.in.appbilling.utils.IabHelper.IabAsyncInProgressException;
import test.in.appbilling.utils.IabResult;
import test.in.appbilling.utils.Inventory;
import test.in.appbilling.utils.Purchase;
...
OnClickListener {
 ...
 // Will the subscription auto-renew?
     ...
     */
    String base64EncodedPublicKey = "";
    // SKU for our subscription (infinite gas)
    static final String SKU_INFINITE_GAS_MONTHLY = "mv_monthly_subscription_test";
    static final String SKU_INFINITE_GAS_YEARLY = "mv_yearly_subscription_test";
        ...
        public void onConsumeFinished(Purchase purchase, IabResult result) {
            ...
            if (result.isSuccess()) {
               ...
               /* Log.d(TAG, "Consumption successful. Provisioning.");
                ...
                saveData();*/
                alert("You filled 1/4 tank. Your tank is now full!");
            }
            else {
